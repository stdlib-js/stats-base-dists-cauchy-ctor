...
bench( format( '%s::get:x0', pkg ), function benchmark( b ) {
	var gamma;
	var dist;
	var x0;
	var y;
...
bench( format( '%s::set:x0', pkg ), function benchmark( b ) {
	var gamma;
	var dist;
	var opts;
	var x0;
...
bench( format( '%s::get:gamma', pkg ), function benchmark( b ) {
	var gamma;
	var dist;
	var x0;
	var y;
...
bench( format( '%s::set:gamma', pkg ), function benchmark( b ) {
	var gamma;
	var dist;
	var opts;
	var x0;
